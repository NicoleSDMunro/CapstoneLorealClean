...
html,body,[class*="css"]{font-family:'Helvetica Neue',Helvetica,Arial,sans-serif}.stApp{background:#000;color:#f5f5f5}.block-container{padding-top:.25rem;max-width:1188px}[data-testid="stHeader"]{background:transparent}#MainMenu,footer{visibility:hidden}.hero-title{font-family:'Barlow Condensed','Helvetica Neue',Helvetica,Arial,sans-serif;font-size:26px;line-height:1;font-weight:700;letter-spacing:.04em;text-transform:uppercase;margin-bottom:10px;color:#fff;white-space:nowrap;overflow:hidden}.hero-subtitle{color:#9ca3af;font-size:10px;font-weight:300;margin-bottom:28px}.empty-panel{background:#101010;border:1px dashed #3a3a3a;border-radius:10px;padding:34px 28px;margin-top:22px}.empty-title{font-size:24px;font-weight:850;margin-bottom:8px}.empty-text{color:#a5a5a5;font-size:15px;line-height:1.6}.stSelectbox label{color:#60646f!important;text-transform:uppercase;letter-spacing:.08em;font-size:9px!important;font-weight:400}.stSelectbox [data-baseweb="select"]>div{background:#151515!important;border:1px solid #333!important;border-radius:6px!important;color:#e5e7eb!important}.stSelectbox [data-baseweb="select"] span{color:#e5e7eb!important;font-size:12px!important;font-weight:400}.info-card{height:80px;background:#111;border:.5px solid #2a2a2a;border-radius:6px;box-sizing:border-box;padding:14px 16px;display:flex;flex-direction:column;justify-content:center}.info-label{color:#555;font-size:9px;font-weight:400;letter-spacing:.07em;text-transform:uppercase;line-height:1;margin-bottom:12px}.info-value{font-size:12px;font-weight:600;line-height:1.05;white-space:nowrap}.info-sub{color:#999;font-size:9px;font-weight:400;line-height:1.2;margin-top:9px;white-space:nowrap}.orange{color:#e8a24a}.red{color:#f05a5f}.green{color:#1ca37e}.tab-single{margin:34px 0 22px}.tab-single span{display:inline-block;padding:0 26px 14px;text-transform:uppercase;letter-spacing:.07em;font-size:10px;font-weight:600;color:#fff;border-bottom:4px solid #fff}.review-title{font-size:12px;font-weight:600;letter-spacing:.02em;margin:10px 0 18px}.month-row div[data-testid="stButton"] button,[data-testid="stButton"] button[kind="secondary"]{height:38px!important;border-radius:8px!important;border:1px solid #333!important;background:#171717!important;color:#d1d5db!important;font-size:10px!important;font-weight:300!important;box-shadow:none!important}.month-row div[data-testid="stButton"] button p,[data-testid="stButton"] button[kind="secondary"] p{color:#d1d5db!important;font-size:10px!important;font-weight:300!important}.month-row div[data-testid="stButton"] button:hover,[data-testid="stButton"] button[kind="secondary"]:hover{background:#222!important;border-color:#454545!important;color:#fff!important}.month-row div[data-testid="stButton"] button[kind="primary"]{background:var(--accent)!important;color:#fff!important;border-color:var(--accent)!important;font-weight:700!important}.month-row div[data-testid="stButton"] button[kind="primary"] p{color:#fff!important;font-weight:700!important}.section-title{color:#9a9a9a;text-transform:uppercase;letter-spacing:.08em;font-size:9px;font-weight:400;margin:24px 0 10px}.chart-card{background:#101010;border:1px solid #2a2a2a;border-radius:8px;padding:8px 12px 2px}.alert-box,.warn-box,.success-box{border-radius:8px;padding:16px 20px;color:#fff;font-size:11px;font-weight:400;line-height:1.6;margin-bottom:10px}.alert-box{background:linear-gradient(90deg,rgba(239,68,68,.22),rgba(239,68,68,.05));border-left:6px solid #ef4444}.warn-box{background:linear-gradient(90deg,rgba(250,204,21,.18),rgba(250,204,21,.04));border-left:6px solid #facc15}.success-box{background:linear-gradient(90deg,rgba(22,163,123,.20),rgba(22,163,123,.04));border-left:6px solid #16a37b}.trigger-pills{display:flex;flex-wrap:wrap;gap:14px;margin:12px 0 16px}.trigger-pill-red{border:1px solid #ef4444;color:#ef4444;border-radius:999px;padding:8px 14px;font-size:11px}.trigger-pill-orange{border:1px solid #f97316;color:#f97316;border-radius:999px;padding:8px 14px;font-size:11px}.trigger-pill-yellow{border:1px solid #d49100;color:#d49100;border-radius:999px;padding:8px 14px;font-size:11px}.decision-table-wrap{background:#101010;border:1px solid #2a2a2a;border-radius:10px;padding:14px;margin:10px 0 16px}.decision-note{color:#9ca3af;font-size:11px;line-height:1.5;margin:0 0 10px}.decision-summary{display:flex;gap:10px;flex-wrap:wrap;margin:8px 0 12px}.decision-chip{border:1px solid #303030;border-radius:999px;padding:7px 12px;color:#d1d5db;background:#0b0b0b;font-size:10px}.decision-table{width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;border-radius:8px;border:1px solid #2a2a2a;background:#111}.decision-table th{background:#1a1a1a;color:#9ca3af;text-align:left;padding:12px 10px;font-size:9px;font-weight:500;text-transform:uppercase;border-bottom:1px solid #2a2a2a}.decision-table td{background:#111;color:#d1d5db;padding:12px 10px;font-size:9px;font-weight:400;border-bottom:1px solid #242424;vertical-align:top}.decision-table tr:last-child td{border-bottom:0}.decision-table tr.green td{background:rgba(34,197,94,.10)}.decision-table tr.yellow td{background:rgba(250,204,21,.11)}.decision-table tr.red td{background:rgba(239,68,68,.13)}.decision-table td:first-child{font-weight:700;color:#f5f5f5}.decision-table .status{font-weight:800;color:#f5f5f5;white-space:nowrap}
</style>
...
items=[("ORIGEM",info["Origem"],"","orange"),("LT MAX",f"{lt_sem:.0f} sem",f"aprox {lt_meses:.1f}m - {lt_dias}d",lt_cls),("COB. TARGET",f"{ct_dias:.0f}d",f"aprox {ct_dias/30:.1f}m - {ct_dias/7:.1f}sem",ct_cls),("DEMANDA",info["Demanda"],"",dem_cls),("EST. FINAL",fmt(est_final),"última rev - jun/26",est_cls)]
...
if prev_idx>=0:
    ...
    var_pv=(pivot.set_index("Mes")["PV"]-prev["PV"])/prev["PV"].replace(0,np.nan); meses_acima=int((var_pv.abs()>.10).sum())
...
fig.update_layout(paper_bgcolor="#101010",plot_bgcolor="#101010",font=dict(family="Helvetica Neue, Helvetica, Arial, sans-serif",color="#999",size=9),height=430,margin=dict(l=30,r=18,t=18,b=35),legend=dict(orientation="h",y=-.22,x=.20,font=dict(size=10,color="#999")),xaxis=dict(gridcolor="#202020",zerolinecolor="#202020"),yaxis=dict(gridcolor="#202020",zerolinecolor="#202020"),hovermode="x unified",hoverlabel=dict(bgcolor="#171717",bordercolor="#2a2a2a",font=dict(color="#f5f5f5",size=10)))
...
if prev_idx>=0 and prev is not None:
    atual=pivot.set_index("Mes")[[c for c in ["PV","Producao","Estoque"] if c in pivot]]; anterior=prev[[c for c in ["PV","Producao","Estoque"] if c in prev]]; tab=((atual-anterior)/anterior.replace(0,np.nan)*100).round(1).reset_index()
